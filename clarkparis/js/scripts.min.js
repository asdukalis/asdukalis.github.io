...
$(function(){$(window).resize(function(){$(window).width()<769?$("#my-menu").mmenu({extensions:["theme-dark","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.svg" alt="GYM">'},offCanvas:{position:"right"}}):$("#my-menu").addClass("show")}),$(".partners").owlCarousel({loop:!0,items:1,smartSpeed:700,dots:!0,dotsData:!0,nav:!1,responsiveClass:!0,autoplay:!0,autoplayTimeout:6e3}),$(".carousel-services").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left"></i> prev',' next <i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:2,autoplay:!0,autoplayTimeout:3e3},480:{items:3},768:{items:4},1200:{items:5}}})});